...
const file_daemon_daemon_proto_rawDesc = "" +
	...
	"\x14incoming_dial_errors\x18\a \x01(\x03R\x12incomingDialErrors2\xca\r\n" +
	"\x06Daemon\x12C\n" +
...
var file_daemon_daemon_proto_depIdxs = []int32{
	...
	18, // 34: telepresence.daemon.Daemon.AddLocalClientRedirect:input_type -> telepresence.daemon.ReroutePortRequest
	18, // 35: telepresence.daemon.Daemon.RemoveLocalClientRedirect:input_type -> telepresence.daemon.ReroutePortRequest
	33, // 36: telepresence.daemon.Daemon.ListLocalClientRedirects:input_type -> google.protobuf.Empty
	33, // 37: telepresence.daemon.Daemon.ActivityWatcher:input_type -> google.protobuf.Empty
	8,  // 38: telepresence.daemon.Daemon.WatchAgentPods:input_type -> telepresence.daemon.AgentPodsDelta
	28, // 39: telepresence.daemon.Daemon.Version:output_type -> telepresence.common.VersionInfo
	0,  // 40: telepresence.daemon.Daemon.Status:output_type -> telepresence.daemon.DaemonStatus
	23, // 41: telepresence.daemon.Daemon.Quit:output_type -> telepresence.daemon.QuitResponse
	0,  // 42: telepresence.daemon.Daemon.Connect:output_type -> telepresence.daemon.DaemonStatus
	33, // 43: telepresence.daemon.Daemon.Disconnect:output_type -> google.protobuf.Empty
	7,  // 44: telepresence.daemon.Daemon.GetNetworkConfig:output_type -> telepresence.daemon.NetworkConfig
	33, // 45: telepresence.daemon.Daemon.SetDNSTopLevelDomains:output_type -> google.protobuf.Empty
	33, // 46: telepresence.daemon.Daemon.SetDNSExcludes:output_type -> google.protobuf.Empty
	33, // 47: telepresence.daemon.Daemon.SetDNSMappings:output_type -> google.protobuf.Empty
	33, // 48: telepresence.daemon.Daemon.SetLogLevel:output_type -> google.protobuf.Empty
	15, // 49: telepresence.daemon.Daemon.TranslateEnvIPs:output_type -> telepresence.daemon.Environment
	33, // 50: telepresence.daemon.Daemon.WaitForNetwork:output_type -> google.protobuf.Empty
	12, // 51: telepresence.daemon.Daemon.WaitForAgentIP:output_type -> telepresence.daemon.WaitForAgentIPResponse
	14, // 52: telepresence.daemon.Daemon.LookupIP:output_type -> telepresence.daemon.LookupIPResponse
	33, // 53: telepresence.daemon.Daemon.RerouteRemotePort:output_type -> google.protobuf.Empty
	33, // 54: telepresence.daemon.Daemon.SetInterceptShortcuts:output_type -> google.protobuf.Empty
	33, // 55: telepresence.daemon.Daemon.AddLocalClientRedirect:output_type -> google.protobuf.Empty
	33, // 56: telepresence.daemon.Daemon.RemoveLocalClientRedirect:output_type -> google.protobuf.Empty
	22, // 57: telepresence.daemon.Daemon.ListLocalClientRedirects:output_type -> telepresence.daemon.LocalClientRedirects
	24, // 58: telepresence.daemon.Daemon.ActivityWatcher:output_type -> telepresence.daemon.Activity
	33, // 59: telepresence.daemon.Daemon.WatchAgentPods:output_type -> google.protobuf.Empty
