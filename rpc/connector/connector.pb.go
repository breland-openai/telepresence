...
const file_connector_connector_proto_rawDesc = "" +
	...
	"\fintercept_id\x18\x01 \x01(\tR\vinterceptId2\xe5\x1a\n" +
	"\tConnector\x12C\n" +
...
var file_connector_connector_proto_depIdxs = []int32{
	...
	50, // 62: telepresence.connector.Connector.AddLocalClientRedirect:input_type -> telepresence.daemon.ReroutePortRequest
	50, // 63: telepresence.connector.Connector.RemoveLocalClientRedirect:input_type -> telepresence.daemon.ReroutePortRequest
	42, // 64: telepresence.connector.Connector.ListLocalClientRedirects:input_type -> google.protobuf.Empty
	32, // 65: telepresence.connector.Connector.Version:output_type -> telepresence.common.VersionInfo
	32, // 66: telepresence.connector.Connector.RootDaemonVersion:output_type -> telepresence.common.VersionInfo
	32, // 67: telepresence.connector.Connector.TrafficManagerVersion:output_type -> telepresence.common.VersionInfo
	51, // 68: telepresence.connector.Connector.AgentImageFQN:output_type -> telepresence.manager.AgentImageFQN
	38, // 69: telepresence.connector.Connector.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	5,  // 70: telepresence.connector.Connector.Connect:output_type -> telepresence.connector.ConnectInfo
	42, // 71: telepresence.connector.Connector.Disconnect:output_type -> google.protobuf.Empty
	21, // 72: telepresence.connector.Connector.GetClusterSubnets:output_type -> telepresence.connector.ClusterSubnets
	5,  // 73: telepresence.connector.Connector.Status:output_type -> telepresence.connector.ConnectInfo
	42, // 74: telepresence.connector.Connector.CanIntercept:output_type -> google.protobuf.Empty
	11, // 75: telepresence.connector.Connector.Ingest:output_type -> telepresence.connector.IngestInfo
	11, // 76: telepresence.connector.Connector.GetIngest:output_type -> telepresence.connector.IngestInfo
	11, // 77: telepresence.connector.Connector.LeaveIngest:output_type -> telepresence.connector.IngestInfo
	38, // 78: telepresence.connector.Connector.CreateIntercept:output_type -> telepresence.manager.InterceptInfo
	42, // 79: telepresence.connector.Connector.RemoveIntercept:output_type -> google.protobuf.Empty
	42, // 80: telepresence.connector.Connector.RevokeIntercept:output_type -> google.protobuf.Empty
	42, // 81: telepresence.connector.Connector.Uninstall:output_type -> google.protobuf.Empty
	14, // 82: telepresence.connector.Connector.List:output_type -> telepresence.connector.WorkloadInfoSnapshot
	14, // 83: telepresence.connector.Connector.WatchWorkloads:output_type -> telepresence.connector.WorkloadInfoSnapshot
	42, // 84: telepresence.connector.Connector.SetLogLevel:output_type -> google.protobuf.Empty
	52, // 85: telepresence.connector.Connector.Quit:output_type -> telepresence.daemon.QuitResponse
	17, // 86: telepresence.connector.Connector.GatherLogs:output_type -> telepresence.connector.LogsResponse
	42, // 87: telepresence.connector.Connector.AddInterceptor:output_type -> google.protobuf.Empty
	42, // 88: telepresence.connector.Connector.RemoveInterceptor:output_type -> google.protobuf.Empty
	19, // 89: telepresence.connector.Connector.GetNamespaces:output_type -> telepresence.connector.GetNamespacesResponse
	53, // 90: telepresence.connector.Connector.GetKnownWorkloadKinds:output_type -> telepresence.manager.KnownWorkloadKinds
	42, // 91: telepresence.connector.Connector.RemoteMountAvailability:output_type -> google.protobuf.Empty
	20, // 92: telepresence.connector.Connector.GetConfig:output_type -> telepresence.connector.ClientConfig
	42, // 93: telepresence.connector.Connector.SetDNSExcludes:output_type -> google.protobuf.Empty
	42, // 94: telepresence.connector.Connector.SetDNSMappings:output_type -> google.protobuf.Empty
	54, // 95: telepresence.connector.Connector.GetAgentConfig:output_type -> telepresence.manager.AgentConfigResponse
	23, // 96: telepresence.connector.Connector.ResolveSyntheticIP:output_type -> telepresence.connector.ResolveSyntheticResponse
	55, // 97: telepresence.connector.Connector.LookupIP:output_type -> telepresence.daemon.LookupIPResponse
	56, // 98: telepresence.connector.Connector.ResolvePort:output_type -> telepresence.daemon.ResolvePortResponse
	42, // 99: telepresence.connector.Connector.RerouteLocalPort:output_type -> google.protobuf.Empty
	42, // 100: telepresence.connector.Connector.RerouteRemotePort:output_type -> google.protobuf.Empty
	42, // 101: telepresence.connector.Connector.AddLocalClientRedirect:output_type -> google.protobuf.Empty
	42, // 102: telepresence.connector.Connector.RemoveLocalClientRedirect:output_type -> google.protobuf.Empty
	57, // 103: telepresence.connector.Connector.ListLocalClientRedirects:output_type -> telepresence.daemon.LocalClientRedirects
