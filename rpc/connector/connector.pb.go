...
var file_connector_connector_proto_goTypes = []any{
	...
	(*daemon.LocalClientRedirects)(nil),     // 56: telepresence.daemon.LocalClientRedirects
}
var file_connector_connector_proto_depIdxs = []int32{
	...
	49, // 61: telepresence.connector.Connector.AddLocalClientRedirect:input_type -> telepresence.daemon.ReroutePortRequest
	49, // 62: telepresence.connector.Connector.RemoveLocalClientRedirect:input_type -> telepresence.daemon.ReroutePortRequest
	41, // 63: telepresence.connector.Connector.ListLocalClientRedirects:input_type -> google.protobuf.Empty
	32, // 64: telepresence.connector.Connector.Version:output_type -> telepresence.common.VersionInfo
	32, // 65: telepresence.connector.Connector.RootDaemonVersion:output_type -> telepresence.common.VersionInfo
	32, // 66: telepresence.connector.Connector.TrafficManagerVersion:output_type -> telepresence.common.VersionInfo
	50, // 67: telepresence.connector.Connector.AgentImageFQN:output_type -> telepresence.manager.AgentImageFQN
	38, // 68: telepresence.connector.Connector.GetIntercept:output_type -> telepresence.manager.InterceptInfo
	5,  // 69: telepresence.connector.Connector.Connect:output_type -> telepresence.connector.ConnectInfo
	41, // 70: telepresence.connector.Connector.Disconnect:output_type -> google.protobuf.Empty
	...
	41, // 73: telepresence.connector.Connector.CanIntercept:output_type -> google.protobuf.Empty
	...
	41, // 78: telepresence.connector.Connector.RemoveIntercept:output_type -> google.protobuf.Empty
	41, // 79: telepresence.connector.Connector.RevokeIntercept:output_type -> google.protobuf.Empty
	41, // 80: telepresence.connector.Connector.Uninstall:output_type -> google.protobuf.Empty
	...
	41, // 83: telepresence.connector.Connector.SetLogLevel:output_type -> google.protobuf.Empty
	51, // 84: telepresence.connector.Connector.Quit:output_type -> telepresence.daemon.QuitResponse
	17, // 85: telepresence.connector.Connector.GatherLogs:output_type -> telepresence.connector.LogsResponse
	41, // 86: telepresence.connector.Connector.AddInterceptor:output_type -> google.protobuf.Empty
	41, // 87: telepresence.connector.Connector.RemoveInterceptor:output_type -> google.protobuf.Empty
	19, // 88: telepresence.connector.Connector.GetNamespaces:output_type -> telepresence.connector.GetNamespacesResponse
	52, // 89: telepresence.connector.Connector.GetKnownWorkloadKinds:output_type -> telepresence.manager.KnownWorkloadKinds
	41, // 90: telepresence.connector.Connector.RemoteMountAvailability:output_type -> google.protobuf.Empty
	20, // 91: telepresence.connector.Connector.GetConfig:output_type -> telepresence.connector.ClientConfig
	41, // 92: telepresence.connector.Connector.SetDNSExcludes:output_type -> google.protobuf.Empty
	41, // 93: telepresence.connector.Connector.SetDNSMappings:output_type -> google.protobuf.Empty
	53, // 94: telepresence.connector.Connector.GetAgentConfig:output_type -> telepresence.manager.AgentConfigResponse
	23, // 95: telepresence.connector.Connector.ResolveSyntheticIP:output_type -> telepresence.connector.ResolveSyntheticResponse
	54, // 96: telepresence.connector.Connector.LookupIP:output_type -> telepresence.daemon.LookupIPResponse
	55, // 97: telepresence.connector.Connector.ResolvePort:output_type -> telepresence.daemon.ResolvePortResponse
	41, // 98: telepresence.connector.Connector.RerouteLocalPort:output_type -> google.protobuf.Empty
	41, // 99: telepresence.connector.Connector.RerouteRemotePort:output_type -> google.protobuf.Empty
	41, // 100: telepresence.connector.Connector.AddLocalClientRedirect:output_type -> google.protobuf.Empty
	41, // 101: telepresence.connector.Connector.RemoveLocalClientRedirect:output_type -> google.protobuf.Empty
	56, // 102: telepresence.connector.Connector.ListLocalClientRedirects:output_type -> telepresence.daemon.LocalClientRedirects
