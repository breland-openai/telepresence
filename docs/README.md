...
- How do I...
  ...
  - [Protect requests for a local intercept](howtos/protected-intercepts.md)
...
- Technical reference
  - [Telepresence CLI](reference/cli/telepresence.md)
    ...
    - [telepresence local-client-redirect](reference/cli/telepresence_local-client-redirect.md)
      - [add](reference/cli/telepresence_local-client-redirect_add.md)
      - [list](reference/cli/telepresence_local-client-redirect_list.md)
      - [remove](reference/cli/telepresence_local-client-redirect_remove.md)
  ...
  - Attachments
    ...
    - [Protected local intercepts](reference/attachments/protected-intercepts.md)
